...
// Loads every registry bundled under `root` (real vanilla data-pack JSON extracted
// from the server jar for this exact protocol version). Each immediate subdirectory of
...
// Loads the registries bundled with this build (share/mcserver/registries,
// embedded via the MCSERVER_REGISTRY_DATA_DIR compile definition — see
// src/CMakeLists.txt).
